...
parser.add_argument("--cborg-model", type=str, required=True,
...
client = openai.OpenAI(
    api_key=os.environ.get('CBORG_API_KEY'),  # API key from environment
...
#with open("cborg_models_list.txt", "w", encoding="utf-8") as f:
#    for m in models.data:
#        f.write(m.id + "\n")   # Write each model ID on a new line

#print("Model list saved to cborg_models_list.txt")

# Assign command line values
models = [args.cborg_model]

...
- **GitHub PR watcher**: GitHub PR mode (polled every 5 seconds) and prompt as comments, and based on the prompt, the output is either to the PR comments or changes to the local code.
